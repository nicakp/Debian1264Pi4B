...
#deb-src http://ftp.debian.org/debian bookworm-backports main" >> /mnt/etc/apt/sources.list

# Setup bootloader and kernel

wget http://archive.raspberrypi.org/debian/pool/main/r/raspberrypi-firmware/raspberrypi-bootloader_1.20230509~buster-1_armhf.deb
dpkg-deb -x raspberrypi-bootloader_1.20190925-2_armhf.deb /tmp/pi-bootloader/
cp /tmp/pi-bootloader/boot/* /mnt/boot/
rm raspberrypi-bootloader_1.20230509~buster-1_armhf.deb
